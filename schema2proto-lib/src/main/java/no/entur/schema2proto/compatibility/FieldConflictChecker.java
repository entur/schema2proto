...
public class FieldConflictChecker {
	...
	private void recordRenumbering(ProtoFile file, MessageType protoMessage, ProtolockMessage protolockMessage, ProtolockField declaredField, int assignedTag,
			Map<Integer, String> lockFieldsInLockMapIdToName) {
