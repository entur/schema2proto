...
module. That module now instead holds schema2proto's mutable proto model on top of stock wire (`no.entur.schema2proto.wire`),
for loading, modifying and serializing proto files, with plain transitive dependencies for use outside schema2proto-lib.
